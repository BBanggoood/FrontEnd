    ...
    useEffect(() => {
        const fetchUserData = async () => {
            try {
                ...
                if (setbxId) {
                    const response = await axios.post('http://hxsx04ukq3.execute-api.ap-northeast-2.amazonaws.com/bbanggoood-stage/userdata', {
                        setbxId
                    }, {
                        headers: {
    ...
    const handleWithdrawal = async () => {
        ...
        if (confirmation) {
            try {
                ...
                const response = await axios.delete('http://hxsx04ukq3.execute-api.ap-northeast-2.amazonaws.com/bbanggoood-stage/account/withdraw', {
